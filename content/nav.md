...
.nav-page h2 {
  ...
  margin: 28px 0 16px;
  padding-bottom: 10px;
  border-bottom: 2px solid var(--efu-theme-op);
...
.link-card::before {
  ...
  position: absolute;
  inset: 0;
  background: linear-gradient(135deg, var(--efu-theme-op), transparent 60%);
  opacity: 0;
...
.link-card:hover {
  ...
  box-shadow: 0 8px 24px var(--efu-shadow-blackdeep);
}

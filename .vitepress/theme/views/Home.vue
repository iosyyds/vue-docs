  ...
  <div class="home">
    ...
    <section class="hero">
      ...
      <div class="hero-inner">
        ...
        <h1 class="hero-title">
          <span v-for="(ch,i) in titleChars" :key="i" class="char" :style="{ animationDelay: i*0.05+'s' }">{{ ch }}</span>
        </h1>
    ...
    <section v-if="pinned.length" class="sec">
      <h2 class="sec-title"><span class="sec-bar"></span>置顶文章</h2>
      <div class="cards">
        <a v-for="(p,i) in pinned" :key="p.url" :href="p.url" class="card featured" :style="{ '--d':i*0.08+'s' }">
          <div class="card-body">
    ...
    <!-- 最新文章 -->
    <section class="sec">
      <h2 class="sec-title"><span class="sec-bar"></span>最新文章</h2>
      <div class="cards">
